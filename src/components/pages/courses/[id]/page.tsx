          ...
          <div className="space-y-8 lg:col-span-8">
            ...
            <div className="grid gap-8 pt-10 md:grid-cols-2">
               ...
               <div className="p-8 rounded-[2rem] bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 shadow-xl shadow-blue-900/5">
                  ...
                  <p className="text-sm leading-relaxed opacity-60">{isRtl ? "تصميم يحاكي المستقبل بلمسات كلاسيكية تضمن الفخامة." : "A design that mimics the future with classic touches."}</p>
               </div>
               <div className="p-8 rounded-[2rem] bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 shadow-xl shadow-blue-900/5">
                  ...
                  <p className="text-sm leading-relaxed opacity-60">{isRtl ? "استخدام تقنيات بناء صديقة للبيئة لضمان جودة الحياة." : "Using eco-friendly building technologies to ensure quality of life."}</p>
               </div>
            </div>
          </div>
          ...
          <div className="sticky lg:col-span-4 top-32">
            <div className={cn(
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-10 space-y-4 text-center bg-slate-500/10">
                ...
                <span className="text-xs font-black tracking-widest uppercase opacity-40">Google Maps Integration</span>
        ...
        <div className="container px-6 mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[1, 2, 3].map((i) => (
              ...
              >
                <img src={project.image} className="object-cover w-full h-full transition-all duration-700 grayscale hover:grayscale-0" alt="gallery" />
              </motion.div>
            ))}
          </div>
        </div>
